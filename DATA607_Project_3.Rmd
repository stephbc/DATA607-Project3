...
This project aims to identify the most valued data science skills by finding the most requested data science skills in job listings. Our team found a set of data on Kaggle called [Data Science Job Postings & Skills](https://www.kaggle.com/datasets/asaniczka/data-science-job-postings-and-skills) that provides Data Science job listings from LinkedIn for 2024. This data set includes three csv files:\
...
First, we will clean up our data from both files. Then, we will normalize the data to prepare it to upload as SQL tables. Finally, we will analyze the data to find out which is the most asked for data science skill in LinkedIn job listings.
...
```{r, echo=FALSE}
library(showimage)
url <- "https://github.com/stephbc/DATA607-Project3/blob/main/diagram_2.png?raw=true"
download.file(url, destfile = "image.png", mode = "wb")
